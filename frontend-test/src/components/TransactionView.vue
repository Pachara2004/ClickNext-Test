  /**
  * =====================================================================
  * @file            TransactionView.vue
  * @since           2026-03-18
  * @author          Pachara Paisrisakul
  * ---------------------------------------------------------------------
  * @description
  *  - แสดงประวัติรายการฝากถอนทั้งหมดในรูปแบบตาราง
  *  - มีปุ่ม Edit สำหรับรายการฝาก และปุ่ม Delete สำหรับรายการถอน
  *  - มี Modal สำหรับแก้ไขและลบรายการ
  *
  * =====================================================================
  */
